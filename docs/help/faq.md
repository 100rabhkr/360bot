...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [I can't access docs.360bot.com (SSL error). What now?](#i-cant-access-docsmoltbot-ssl-error-what-now)
...
```bash
curl -fsSL https://360bot.com/install.sh | bash -s -- --install-method git
```
...
Some Comcast/Xfinity connections incorrectly block `docs.360bot.com` via Xfinity
Advanced Security. Disable it or allowlist `docs.360bot.com`, then retry. More
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://360bot.com/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://360bot.com/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://360bot.com/install.ps1
...
```bash
curl -fsSL https://360bot.com/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://360bot.com/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://360bot.com/install.sh | bash -s -- --install-method git --verbose
```
...
Showcase: https://360bot.com/showcase
